...
inline b32 IsBehindPlane(clip_vertex Vertex, clip_axis Axis)
{
    b32 Result = false;
...
inline clip_vertex CalculateIntersection(clip_vertex Start, clip_vertex End, clip_axis Axis)
{
    clip_vertex Result = {};
...
inline void ClipPolygonToAxis(clip_result* Input, clip_result* Output, clip_axis Axis)
{
